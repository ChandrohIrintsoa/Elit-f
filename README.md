> Livraison du 13 septembre 2026 : analyses AOT vérifiées sur les trois échantillons fournis (Dart 3.8.1 et 3.10.7, Android ARM64, hôte Linux x86_64). Lire `DEMARRAGE.md` et `VALIDATION.md` pour le périmètre exact.
